...
import com.engine.mnsfz.util.ImageWorker;
...
public class ImageDetailFragment extends Fragment {
     ...
     * {@link com.engine.mnsfz.fragment.ImageDetailFragment#newInstance(String)} to create this fragment.
     */
    @Override
    ...
    public void setWallPaper() throws IOException {
      ...
      //  WallpaperManager wallpaperManager = WallpaperManager.getInstance(getActivity());
        ...
        getActivity().setWallpaper(drawable.getBitmap());
